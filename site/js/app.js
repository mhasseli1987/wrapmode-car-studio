/* WRAPMODE — تک‌کلیپ اسکرولی (۹ طرح، سرعت یکنواخت) */
(() => {
  "use strict";

  // ---------- پیکربندی ----------
  const FRAME_DIR = "frames9/clip/";
  const FRAME_COUNT = 255;

  const DESIGNS = [
    { label: "رپ کاپوت — آنیمه صورتی", price: 9500000 },
    { label: "رپ کاپوت — گرافیک زرد/مشکی", price: 12000000 },
    { label: "رپ کامل بدنه — آرت قرمز", price: 15500000 },
    { label: "رپ کامل بدنه — مسابقه‌ای ۶۶", price: 18000000 },
    { label: "رپ کامل بدنه — ریسینگ سفید/قرمز", price: 22500000 },
    { label: "رپ کامل بدنه — دریفیت رنگی", price: 26000000 },
    { label: "رپ کامل بدنه — مشکی/قرمز ۶۶", price: 31000000 },
    { label: "رپ کامل بدنه — آنیمه سفید", price: 38000000 },
    { label: "رپ کامل بدنه — اژدهای دود", price: 45000000 },
  ];
